...
4.  Main Motivation
    ...
    *   In particular, what if there are multiple senders?
        *   Ex:
        ...
        ![Diagram of packet transmission with 2 Mb/s window.](BASEURL_PLACEHOLDER/resources/untitled-1-1)
        
        *   What should happen? Debatable. Reasonable alternative:
        
        ![Diagram of packet transmission with 1 Mb/s window.](BASEURL_PLACEHOLDER/resources/untitled-2)
