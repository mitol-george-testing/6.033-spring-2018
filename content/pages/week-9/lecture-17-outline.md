...
4.  Conflict Graphs
    ...
    *   Example 3:| `T1:` | `T2:` | `T3:` | `T4:` |
        ...
         ![Conflict graph between T1, T2, T3, and T4.](BASEURL_PLACEHOLDER/resources/untitled-1-2)
...
8.  Another Possible Performance Improvement: Giving up on Conflict Serializability.
    ...
    *   Example:
    ...
    Conflict graph:  
    ![Conflict graph between T1, T2, and T3.](BASEURL_PLACEHOLDER/resources/untitled-2-2)
